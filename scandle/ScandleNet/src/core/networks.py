...
class SiameseNet:
    def __init__(self, inputs, arch, siam_reg, y_true):
        ...
        print(self.net,self.net.layers,self.net.updates)
...
class SpectralNet:
    def __init__(self, inputs, arch, spec_reg, y_true, y_train_labeled_onehot,
        ...
        elif affinity in ['ana', 'siamese']:
            W = costs.ana_affinity(input_affinity, n_nbrs, scale=scale, scale_nbr=scale_nbr)
        ...
        # self.learning_rate.initializer
        #tf.Session().run(self.learning_rate.initializer)
        ...
        K.get_session().run(tf.variables_initializer(self.net.trainable_weights))
        #K.get_session().run(tf.variables_initializer(self.learning_rate))
        # K.get_session().run(tf.variables_initializer(self.net.trainable_weights))
